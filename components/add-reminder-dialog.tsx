...
import {
  ...
  type AddTaskDialogClientOption,
  type AddTaskDialogStaffOption,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[480px]">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="reminder-due">{dueLabel}</Label>
            <Input id="reminder-due" type="datetime-local" value={dueAt} onChange={(e) => setDueAt(e.target.value)} />
          </div>
          ...
          {appointments.length > 0 ? (
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="__none__">None — general reminder</SelectItem>
                  {appointments.map((a) => (
              ...
              <p className="text-[11px] text-muted-foreground leading-snug">
                Tie this reminder to a booking for context on the calendar, or leave unlinked.
              </p>
            </div>
          ) : null}
          ...
          {actionMode === 'call' ? (
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground leading-snug">
                Use when no client above is selected, or to add extra numbers for this reminder.
              </p>
            </div>
          ) : null}
          ...
          {actionMode === 'email' ? (
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground leading-snug">
                Selected clients still use their profile emails; these are extra addresses for this reminder.
              </p>
            </div>
          ) : null}
